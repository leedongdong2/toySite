...
$(document).ready(function(){
	$(".single-item").on("init",function(event,slick){
		$(".bannerItemBox").eq(1).find($(".bannerTitle")).addClass("active");
		$(".bannerItemBox").eq(1).find($(".bannerMaker")).addClass("active");
	});
		...
		$(".single-item").on("afterChange",function(event,slick,currentSlide){
			...
			$(".bannerItemBox").find($(".bannerTitle")).removeClass("active");
			$(".bannerItemBox").find($(".bannerMaker")).removeClass("active");
			
			$(".bannerItemBox").eq(currentSlide+1).find($(".bannerTitle")).addClass("active")
			$(".bannerItemBox").eq(currentSlide+1).find($(".bannerMaker")).addClass("active")
